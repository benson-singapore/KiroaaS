...
export const translations = {
  zh: {
    ...
    webSearchSettings: 'Web Search 设置',
    webSearchBudgetDesc: '限制每个请求的搜索轮数和总耗时，达到任一上限后会基于已有结果回答。',
    webSearchMaxLoops: '最大搜索轮数',
    webSearchMaxLoopsDesc: '范围 1–20，默认 8 轮',
    webSearchTimeoutSeconds: '搜索总耗时 (秒)',
    webSearchTimeoutDesc: '范围 10–300 秒，默认 90 秒',
  ...
  en: {
    ...
    webSearchBudgetDesc: 'Limit search rounds and total time per request. The model answers from existing results after either limit is reached.',
    webSearchMaxLoops: 'Maximum search rounds',
    webSearchMaxLoopsDesc: 'Range 1–20, default 8 rounds',
    webSearchTimeoutSeconds: 'Search time budget (seconds)',
    webSearchTimeoutDesc: 'Range 10–300 seconds, default 90 seconds',
  ...
  ru: {
    ...
    webSearchSettings: 'Настройки Web Search',
    webSearchBudgetDesc: 'Ограничивает число поисковых раундов и общее время поиска для одного запроса.',
    webSearchMaxLoops: 'Максимум поисковых раундов',
    webSearchMaxLoopsDesc: 'Диапазон 1–20, по умолчанию 8',
    webSearchTimeoutSeconds: 'Лимит времени поиска (сек.)',
    webSearchTimeoutDesc: 'Диапазон 10–300 секунд, по умолчанию 90',
    ...
    openReleasesPage: 'Открыть страницу Releases',
  ...
  es: {
    ...
    webSearchSettings: 'Configuración de Web Search',
    webSearchBudgetDesc: 'Limita las rondas y el tiempo total de búsqueda por solicitud.',
    webSearchMaxLoops: 'Máximo de rondas de búsqueda',
    webSearchMaxLoopsDesc: 'Rango 1–20, predeterminado 8',
    webSearchTimeoutSeconds: 'Tiempo total de búsqueda (segundos)',
    webSearchTimeoutDesc: 'Rango 10–300 segundos, predeterminado 90',
    ...
    openReleasesPage: 'Abrir página de Releases',
  ...
  id: {
    ...
    webSearchSettings: 'Pengaturan Web Search',
    webSearchBudgetDesc: 'Membatasi jumlah putaran dan waktu pencarian per permintaan.',
    webSearchMaxLoops: 'Maksimum putaran pencarian',
    webSearchMaxLoopsDesc: 'Rentang 1–20, default 8 putaran',
    webSearchTimeoutSeconds: 'Batas waktu pencarian (detik)',
    webSearchTimeoutDesc: 'Rentang 10–300 detik, default 90',
    ...
    openReleasesPage: 'Buka halaman Releases',
  ...
  pt: {
    ...
    webSearchSettings: 'Configurações do Web Search',
    webSearchBudgetDesc: 'Limita as rodadas e o tempo total de pesquisa por solicitação.',
    webSearchMaxLoops: 'Máximo de rodadas de pesquisa',
    webSearchMaxLoopsDesc: 'Intervalo 1–20, padrão 8 rodadas',
    webSearchTimeoutSeconds: 'Tempo total de pesquisa (segundos)',
    webSearchTimeoutDesc: 'Intervalo 10–300 segundos, padrão 90',
  ...
  ja: {
    ...
    webSearchSettings: 'Web Search 設定',
    webSearchBudgetDesc: 'リクエストごとの検索回数と合計時間を制限します。',
    webSearchMaxLoops: '最大検索回数',
    webSearchMaxLoopsDesc: '1～20、デフォルトは8回',
    webSearchTimeoutSeconds: '検索時間上限 (秒)',
    webSearchTimeoutDesc: '10～300秒、デフォルトは90秒',
    ...
    openReleasesPage: 'Releases ページを開く',
  ...
  ko: {
    ...
    webSearchSettings: 'Web Search 설정',
    webSearchBudgetDesc: '요청별 검색 횟수와 총 시간을 제한합니다.',
    webSearchMaxLoops: '최대 검색 횟수',
    webSearchMaxLoopsDesc: '1–20 범위, 기본값 8회',
    webSearchTimeoutSeconds: '검색 시간 제한 (초)',
    webSearchTimeoutDesc: '10–300초 범위, 기본값 90초',
    ...
    downloadUpdate: '다운로드',
    openReleasesPage: 'Releases 페이지 열기',
  ...
  vi: {
    ...
    webSearchSettings: 'Cài đặt Web Search',
    webSearchBudgetDesc: 'Giới hạn số vòng và tổng thời gian tìm kiếm cho mỗi yêu cầu.',
    webSearchMaxLoops: 'Số vòng tìm kiếm tối đa',
    webSearchMaxLoopsDesc: 'Phạm vi 1–20, mặc định 8 vòng',
    webSearchTimeoutSeconds: 'Tổng thời gian tìm kiếm (giây)',
    webSearchTimeoutDesc: 'Phạm vi 10–300 giây, mặc định 90 giây',
    ...
    openReleasesPage: 'Mở trang Releases',
