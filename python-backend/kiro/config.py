...
# Default: 60 seconds (recommended for long-context requests)
# Set a lower value only when faster failure and retry is preferred.
...
# After exhausting all attempts, an error will be returned in the stream.
# Default: 2 attempts
